...
public class MainActivity extends Activity {
    ...
    protected void onResume() {
       ...
       /* if(mCameraManager != null){
            ...
            //mCameraManager.openScanForUid("0", mStateCallback, CameraDeviceImpl.checkAndWrapHandler(mCameraHandler), -1, 0);
            //mCameraManager.openCameraForUid();
            ...
            try {
                ...
                //mCameraManager.openScan("0", mStateCallback, mCameraHandler);
                //openScanForUid
                mCameraManager.openScanForUid("0", mStateCallback, CameraDeviceImpl.checkAndWrapHandler(mCameraHandler), -1);
                Log.d(TAG, "zll1 openCamera 2 mCameraId: 1");
                try {
                    Thread.sleep(10000);
                }catch (InterruptedException e){
                    Log.d(TAG, "zll sleep abnormal!");
                }
                Log.d(TAG, "zll startPreview 0");
                mCameraManager.startPreview();
                Log.d(TAG, "zll startPreview 1");
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                setupImageReader();
                mCameraId = cameraId;
                Log.d(TAG, "zll mCameraId:" + mCameraId);
                break;
            }
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void openCamera() {
        ...
        try {
            ...
            Log.d(TAG, "openCamera 2 mCameraId:" + mCameraId);
            manager.openCamera(mCameraId, mStateCallback, mCameraHandler);
        } catch (CameraAccessException e) {
    ...
    private void stopPreview() {
        try{
            Log.d(TAG, "zll stopPreview start");
            mCameraCaptureSession.stopRepeating();
            Log.d(TAG, "zll stopPreview end");
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    private void restartPreview() {
        try{
            Log.d(TAG, "zll restartPreview start");
            mCameraCaptureSession.setRepeatingRequest(mCaptureRequest, null, mCameraHandler);
            Log.d(TAG, "zll restartPreview end");
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    }
    ...
    public void startPreview_onClick(View view){
        Log.d(TAG, "zll startPreview start");
        /*if( (mCaptureRequest != null) && ( mCameraCaptureSession != null )) {
            restartPreview();
        }else{
            Log.d(TAG, "zll startPreview wanzheng start");
            startPreview();
            Log.d(TAG, "zll startPreview wanzheng end");
        }*/
        if(mCameraManager != null){
            mCameraManager.resumeMeig();
        }
        Log.d(TAG, "zll startPreview end");
        Log.d(TAG, "zll startPreview end");
    }
    ...
    private void setupImageReader() {
        ...
        mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
            ...
            public void onImageAvailable(ImageReader reader) {
                ...
                //Log.d(TAG, "zll " + Log.getStackTraceString(new Throwable()));
