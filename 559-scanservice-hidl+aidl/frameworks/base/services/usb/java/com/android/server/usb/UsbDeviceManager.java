    ...
    abstract static class UsbHandler extends Handler {
        ...
        public void updateState(String state) {
            ...
            if ("DISCONNECTED".equals(state)) {
                ...
                connected = 1;
                configured = 1;
                //<!-- add for task 23061, MTP pop-up diaglog start
                ComponentName comp = new ComponentName("com.android.settings","com.android.settings.deviceinfo.UsbModeChooserActivity");
                Intent intent = new Intent();
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.setComponent(comp);
                mContext.startActivity(intent);
                //add for task 23061, MTP pop-up diaglog end -->
            } else {
