...
public class PermissionUtils {
    ...
    public static boolean checkPermission(Context context, String permission) {
        Log.d("PermissionUtils", "zll checkPermission permission:" + permission);
        if (ContextCompat.checkSelfPermission(context, permission) == PackageManager.PERMISSION_GRANTED) {
            Log.d("PermissionUtils", "zll checkPermission permission:" + permission + ": " + "true.");
            return true;
        }else{
            Log.d("PermissionUtils", "zll checkPermission permission:" + permission + ": " + "false.");
            return false;
        }
    }
