...
public interface ISwfingerprint extends android.hidl.base.V1_0.IBase {
    ...
    /* package private */ static ISwfingerprint asInterface(android.os.IHwBinder binder) {
        ...
        ISwfingerprint proxy = new ISwfingerprint.Proxy(binder);
     ...
     */
    public static ISwfingerprint getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return ISwfingerprint.asInterface(android.os.HwBinder.getService("vendor.sw.swfingerprint@1.0::ISwfingerprint", serviceName, retry));
    }

    /**
     * Calls getService("default",retry).
     */
    public static ISwfingerprint getService(boolean retry) throws android.os.RemoteException {
    ...
    int setNotify(vendor.sw.swfingerprint.V1_0.ISwfingerprintCallback clientCallback)
    ...
    public static final class Proxy implements ISwfingerprint {
        ...
        @Override
        public int setNotify(vendor.sw.swfingerprint.V1_0.ISwfingerprintCallback clientCallback)
                throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.sw.swfingerprint.V1_0.ISwfingerprint.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISwfingerprint {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    vendor.sw.swfingerprint.V1_0.ISwfingerprint.kInterfaceName,
        ...
        public final String interfaceDescriptor() {
            return vendor.sw.swfingerprint.V1_0.ISwfingerprint.kInterfaceName;
            ...
            switch (_hidl_code) {
                case 1 /* setNotify */:
                {
                    ...
                    if (_hidl_is_oneway != false) {
                        ...
                        _hidl_reply.send();
                        break;
                    }_hidl_request.enforceInterface(vendor.sw.swfingerprint.V1_0.ISwfingerprint.kInterfaceName);

                    vendor.sw.swfingerprint.V1_0.ISwfingerprintCallback clientCallback = vendor.sw.swfingerprint.V1_0.ISwfingerprintCallback.asInterface(_hidl_request.readStrongBinder());
