...
public interface ISwfingerprintCallback extends android.hidl.base.V1_0.IBase {
    ...
    /* package private */ static ISwfingerprintCallback asInterface(android.os.IHwBinder binder) {
        ...
        ISwfingerprintCallback proxy = new Proxy(binder);
    ...
    public static ISwfingerprintCallback getService() throws android.os.RemoteException {
        return ISwfingerprintCallback.asInterface(android.os.HwBinder.getService("vendor.sw.swfingerprint@1.0::ISwfingerprintCallback","default"));
    }
    ...
    public static final class Proxy implements ISwfingerprintCallback {
        ...
        public void onSendCmd(int cmd, int arg, int len, java.util.ArrayList<Byte> data)
            ...
            _hidl_request.writeInterfaceToken(ISwfingerprintCallback.kInterfaceName);
            ...
            try {
                mRemote.transact(1 /* onSendCmd */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
    ...
    public static abstract class Stub extends android.os.HwBinder implements ISwfingerprintCallback {
        ...
        public final java.util.ArrayList<String> interfaceChain() {
            return new java.util.ArrayList<String>(java.util.Arrays.asList(
                    ISwfingerprintCallback.kInterfaceName,
                    android.hidl.base.V1_0.IBase.kInterfaceName));
        }

        @Override
        public final String interfaceDescriptor() {
            return ISwfingerprintCallback.kInterfaceName;
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags)
            ...
            switch (_hidl_code) {
                case 1 /* onSendCmd */:
                {
                    _hidl_request.enforceInterface(ISwfingerprintCallback.kInterfaceName);
