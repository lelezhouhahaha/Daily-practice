...
public class BarCodeReader
{
	...
	public final int setTurboMode()
	{
		return(setNumParameter(3000, 1));
	}
	
	public final int clearTurboMode()
	{
		return(setNumParameter(3000, 0));
	}
	...
	public static class ParamNum
	{
		...
		public static final short CONTINUE_BC_READ			= 649;  //      0		1		0
	...
	public static class PropertyNum
	{
		 ...
		 */
		public static final int ENGINE_STATUS			= 19;
		/**
	...
	private class EventHandler extends Handler
	{
		...
		{
			Log.i(TAG, String.format("Event message: %X, arg1=0x%x, arg2=%d", msg.what, msg.arg1, msg.arg2));
			switch ( msg.what )
			{
