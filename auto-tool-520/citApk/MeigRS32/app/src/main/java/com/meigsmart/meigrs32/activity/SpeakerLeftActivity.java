...
public class SpeakerLeftActivity extends BaseActivity implements View.OnClickListener,
        PromptDialog.OnPromptDialogCallBack ,SpeakerListAdapter.OnSpeakerSound{
    private SpeakerLeftActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.SpeakerLeftActivity);
    ...
    private void init(boolean isCustom){
        ...
        songArrayList.add(randomIntsSecond+"_left.wav");
        songplay();
        //mediaPlayer.reset();
