...
public class PCBAAutoDeputyTestMICActivity extends BaseActivity implements PromptDialog.OnPromptDialogCallBack, SpeakerListAdapter.OnSpeakerSound{
    //TextView textview;
    private PCBAAutoDeputyTestMICActivity mContext;
    @BindView(R.id.title)
    ...
    private final String TAG = PCBAAutoDeputyTestMICActivity.class.getSimpleName();
    @Override
