...
import com.meigsmart.meigrs32.camera.CameraPreview_Back_2;
...
public class RearCamera2AutoActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private RearCamera2AutoActivity mContext;
    @BindView(R.id.title)
    ...
    public CameraPreview_Back_2 mCameraPreview = null;
    ...
    protected void initData() {
        ...
        if (mCameraPreview.getCameraInstance() == null) {
            ...
            Toast toast = Toast.makeText(RearCamera2AutoActivity.this, R.string.camera_msg_no, Toast.LENGTH_LONG);
    ...
    private void initCamera() {
        ...
        mCameraPreview = new CameraPreview_Back_2(this,mCameraId);
        ...
        if (v == takepicture) {
            if (mCameraPreview != null && mCameraPreview.isPreviewing) {//hejianfeng modif for zendao12318
                ...
                if (takePhoto) {
                    ...
                    Toast toast = Toast.makeText(RearCamera2AutoActivity.this, R.string.camera_msg_error, Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }
