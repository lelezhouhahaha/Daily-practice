...
public class RearCamera3AutoActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private RearCamera3AutoActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        if (mCameraPreview.getCameraInstance() == null) {
            ...
            Toast toast = Toast.makeText(RearCamera3AutoActivity.this, R.string.camera_msg_no, Toast.LENGTH_LONG);
        ...
        if (v == takepicture) {
            if (mCameraPreview != null && mCameraPreview.isPreviewing) {//hejianfeng modif for zendao12318
                ...
                if (takePhoto) {
                    ...
                    Toast toast = Toast.makeText(RearCamera3AutoActivity.this, R.string.camera_msg_error, Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }
