...
public class NinePinOtgActivity  extends BaseActivity implements View.OnClickListener,PromptDialog.OnPromptDialogCallBack{
    private NinePinOtgActivity mContext;
    @BindView(com.meigsmart.meigrs32.R.id.title)
    public TextView mTitle;
    @BindView(com.meigsmart.meigrs32.R.id.back)
    public LinearLayout mBack;
    private String mFatherName = "";
    private NinePinOtgActivity.NinepinUsbDeviceReceiver mReceiver = null;
    ...
    protected void initData() {
        ...
        mTitle.setText(com.meigsmart.meigrs32.R.string.NinePinOtgActivity);

        mDialog.setCallBack(this);
        mFatherName = getIntent().getStringExtra("fatherName");
        super.mName = getIntent().getStringExtra("name");
        addData(mFatherName,super.mName);
		writeToFile(OTG_STATE_PATH,MODE_NPIN);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1001:
                    mReceiver = new NinePinOtgActivity.NinepinUsbDeviceReceiver();
    ...
    class NinepinUsbDeviceReceiver extends BroadcastReceiver {
        @Override
