...
public class RJ11BTestActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{
    private RJ11BTestActivity mContext;
    @BindView(R.id.title)
    ...
    public  final String TAG_RJ11B_PATH_NODE = "common_cit_rj11b_node";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.RJ11BTestActivity);
        ...
        String path = DataUtil.initConfig(Const.CIT_COMMON_CONFIG_PATH, TAG_RJ11B_PATH_NODE);
