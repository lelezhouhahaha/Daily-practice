...
public class SpeakerRightAndLeftActivity extends BaseActivity implements View.OnClickListener,
        PromptDialog.OnPromptDialogCallBack ,SpeakerListAdapter.OnSpeakerSound{
    private SpeakerRightAndLeftActivity mContext;
    @BindView(R.id.title)
    ...
    @Override
    protected int getLayoutId() { return R.layout.activity_doublespeaker; }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.SpeakerRightAndLeftActivity);
    ...
    private void init(boolean isCustom){
        ...
        songArrayList.add(randomInt+"_left.wav");
    ...
    private void nextsong() {
        ...
        if (songIndex < songArrayList.size() - 1) {
            ...
            mchannel.setText(R.string.Therightchannel);
        }
        else {
            songIndex = 0;
            mchannel.setText(R.string.Theleftchannel);
