...
public class SpeakPhoneActivity extends BaseActivity implements OnClickListener, PromptDialog.OnPromptDialogCallBack, SpeakerListAdapter.OnSpeakerSound{
    TextView textview;
    private SpeakPhoneActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_speak_phone;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.pcba_audio_speakphone);
