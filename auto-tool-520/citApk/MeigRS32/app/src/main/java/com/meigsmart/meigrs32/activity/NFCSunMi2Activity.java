...
public class NFCSunMi2Activity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{

    private NFCSunMi2Activity mContext;
    @BindView(R.id.title)
    ...
    private String TAG = "NFCSunMi2Activity";
    ...
    protected void initData() {
        ...
        if (!MyApplication.getInstance().isConnectPaySDK()) {
            Log.i("MM0927", "NFCSunMi2Activity isConnectPaySDK");
 ...
 /*           if (!isFinishing()) {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1000:
                    Log.i("MM0927", "NFCSunMi2Activity 1000");
                    sendApduToCheck();
                    moveCard();
                    break;
                case 1001:
                    Log.i(TAG, "MM0927 NFCSunMi2Activity checkCard 1001");
                    checkCard();
                    initTransData();
                    break;
                case 1002:
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (code < 0) {
                        Log.i("MM0927","NFCSunMi2Activity apduCommand failed,code:" + code);
                    } else{
