...
public class TenPinUartActivity extends BaseActivity implements View.OnClickListener,PromptDialog.OnPromptDialogCallBack{
    private TenPinUartActivity mContext;
    ...
    private String NPUART_PATH = "/dev/ttyHSL1";
    ...
    protected void initData() {
        ...
        mTitle.setText(com.meigsmart.meigrs32.R.string.TenPinUartActivity);
