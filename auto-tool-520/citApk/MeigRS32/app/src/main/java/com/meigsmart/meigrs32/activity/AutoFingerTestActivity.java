...
public class AutoFingerTestActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private AutoFingerTestActivity mContext;
    @BindView(R.id.title)
    ...
    private static final String TAG = "AutoFingerTestActivity";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.AutoFingerTestActivity);
        ...
        intent.putExtra("FingerTestStartType", "auto");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(TAG,"AutoFingerTestActivity resultCode: <" + resultCode + ">.");
        Log.d(TAG,"AutoFingerTestActivity requestCode: <" + requestCode + ">.");
        if("MT537".equals(projectName)){
            if(resultCode == 2){
