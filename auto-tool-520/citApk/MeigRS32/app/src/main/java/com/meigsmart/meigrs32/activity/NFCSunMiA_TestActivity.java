...
public class NFCSunMiA_TestActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{

    private NFCSunMiA_TestActivity mContext;
    @BindView(R.id.title)
    ...
    private String TAG = "NFCSunMiA_TestActivity";
    Timer timer;
    ...
    TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if(str1&&str2){
                if(mUuid1.getText().toString().equals("result:0A00")&&
                        mUuid2.getText().toString().equals("result:0B04")){
