...
public class MMI1_FunctionSignalActivity extends BaseActivity implements View.OnClickListener, CheckListAdapter.OnCallBackCheckFunction {
    private MMI1_FunctionSignalActivity mContext;
    @BindView(R.id.title)
    ...
    private String TAG = "MMI1_FunctionSignalActivity";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.mmi_one_test_manual);

        mDefaultPath = getResources().getString(R.string.mmi1_function_signal_save_log_default_path);
        mFileName = getResources().getString(R.string.mmi1_function_signal_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.mmi1_function_signal_save_log_is_user_custom);
        mCustomPath = getResources().getString(R.string.mmi1_function_signal_save_log_custom_path);
        ...
        String Name = getStringFromName(mContext, getResources().getString(R.string.MM1_FunctionActivity));
        if (!TextUtils.isEmpty(Name)) {
            super.mList = getFatherData(Name);
        }

        List<String> config = Const.getXmlConfig(this, Const.CONFIG_MMI1_PRE_SIGNAL);
