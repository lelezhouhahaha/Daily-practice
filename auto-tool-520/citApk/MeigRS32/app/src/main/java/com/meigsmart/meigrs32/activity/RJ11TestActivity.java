...
public class RJ11TestActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{
    private RJ11TestActivity mContext;
    @BindView(R.id.title)
    ...
    public  final String TAG_RJ11_PATH_NODE = "common_cit_rj11_node";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.run_in_rj11test);
        ...
        String path = DataUtil.initConfig(Const.CIT_COMMON_CONFIG_PATH, TAG_RJ11_PATH_NODE);
