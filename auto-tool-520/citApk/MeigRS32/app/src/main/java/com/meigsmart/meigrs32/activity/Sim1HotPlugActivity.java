...
public class Sim1HotPlugActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private Sim1HotPlugActivity mContext;
    @BindView(R.id.title)
...
//        mTitle.setText(R.string.pcba_sim1_hot_plug);
    ...
    private Handler mHandler = new Handler() {
            ...
            switch (msg.what) {
                case 1002:
                    setdefaultLanguage(Sim1HotPlugActivity.this);
