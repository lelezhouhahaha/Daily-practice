...
public class LCDandSpeakerActivity extends BaseActivity implements View.OnClickListener ,
    ...
    private LCDandSpeakerActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.lcd_sperker_test);
