...
public class ScanActivitySS1100FarFocus extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private ScanActivitySS1100FarFocus mContext;
    @BindView(R.id.title)
    ...
    private final String TAG = ScanActivitySS1100FarFocus.class.getSimpleName();
    private String SS1100_FAR_COMPARE_VALUE = "https://cli.im/text";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.ScanActivitySS1100FarFocus);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(mProjectName.equals("MC520_GMS") && !buildType.equals("userdebug")){
            if(result.equals(SS1100_FAR_COMPARE_VALUE)){//if(result.equals("scan:true")) {
                mScanFlag = true;
        ...
        }else if(result.equals(SS1100_FAR_COMPARE_VALUE)){//if(result.equals("scan:true")) {
            mScanFlag = true;
            LogUtil.d(" onActivityResult scantype SS1100 active decode sucess");
            mHandler.sendEmptyMessage(HANDLER_SS1100_RESULT_CODE);
        }else{
