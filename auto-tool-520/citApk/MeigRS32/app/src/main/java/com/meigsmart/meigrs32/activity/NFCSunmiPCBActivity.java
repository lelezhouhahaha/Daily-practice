...
public class NFCSunmiPCBActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{

    private NFCSunmiPCBActivity mContext;
    @BindView(R.id.title)
    ...
    public final String TAG="NFCSunmiPCBActivity";
    private int mConfigTime = 0;
    private Runnable mRun;

    @Override
    protected int getLayoutId() {
        return R.layout.activity_nfc_sunmi_pcba;
    }
...
//            ToastUtil.showCenterShort(error);
    ...
    private void handleResult(int type, Bundle info) {
        ...
        mHandler.post(() -> {
            if (type == 1) {// find NFC
                mUuid.setText("UUID:"+info.getString("uuid"));
