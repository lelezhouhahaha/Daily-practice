...
public class Sim2HotPlugActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private Sim2HotPlugActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.pcba_sim2_hot_plug);
        ...
        mRun.run();
        if (telMgr != null) {
            if (telMgr.getSimState(1) == TelephonyManager.SIM_STATE_READY) {
                showDevice();
    ...
    private Handler mHandler = new Handler() {
            ...
            switch (msg.what) {
                case 1002:
                    setdefaultLanguage(Sim2HotPlugActivity.this);
    ...
    private void showDevice() {
        ...
        for (i = 0; i < keyList.size(); i++) {
            mSim.append(keyList.get(i) + resultList1.get(i) + "\n");
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(ACTION_SIM_STATE_CHANGED)) {
                ...
                if(phoneId!=1)
                    ...
                    LogUtil.d("chenyong citapk onReceive state:" + state );
                switch (state) {
