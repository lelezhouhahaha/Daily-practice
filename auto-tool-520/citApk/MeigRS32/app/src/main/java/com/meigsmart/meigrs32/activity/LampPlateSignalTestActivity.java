...
public class LampPlateSignalTestActivity extends BaseActivity implements View.OnClickListener , CheckListAdapter.OnCallBackCheckFunction {
    private LampPlateSignalTestActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_lamp_plate_signal_test;
    }
    ...
    protected void initData() {
        ...
        mDefaultPath = getResources().getString(R.string.lamp_plate_signal_save_log_default_path);
        mFileName = getResources().getString(R.string.lamp_plate_signal_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.lamp_plate_signal_save_log_is_user_custom);
        mCustomPath = getResources().getString(R.string.lamp_plate_signal_save_log_custom_path);
        ...
        if(super.mName!=null) {
            if (super.mName.equals(getResources().getString(R.string.CameraPlateSignalTestActivity))) {
                mTitle.setText(R.string.CameraPlateSignalTestActivity);
            } else {
                mTitle.setText(R.string.LampPlateSignalTestActivity);
            }
        }
        ...
        List<String> config = Const.getXmlConfig(this, Const.CONFIG_LAMP_PLATE_SIGNAL);
...
//                    initPath(isCustomPath?mCustomPath:mDefaultPath,mFileName,createJsonResult());
    ...
    private void saveLog() {
        List<FunctionBean> list = getFatherData(LampPlateSignalTestActivity.super.mName);
        ...
        allResultModel.setName("lamp_all");
        ...
        writePersistResult(Const.getLogPath(Const.TYPE_LOG_PATH_FILE),  Const.LAMP_PLATE_AUTO_RESULT_FILE, JSON.toJSONString(persistResultList));
    }
