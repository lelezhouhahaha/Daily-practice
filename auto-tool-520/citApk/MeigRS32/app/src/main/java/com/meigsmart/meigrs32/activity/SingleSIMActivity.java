...
public class SingleSIMActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private SingleSIMActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_single_sim;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.SingleSIMActivity);
    ...
    private List<String> getResultList(int simId) {
        ...
        if (telMgr.getSimState(simId) == TelephonyManager.SIM_STATE_READY) {
            ...
            LogUtil.d("ojellyoooooooooooooooooooooqqqooooooooo");
            ...
            LogUtil.d("ojellyooqqqqqqqqqqqqqqqqoo");

        }
        if(!(projectName.equals("MT537")&&SystemProperties.get("ro.build.version.release").equals("11"))) {
