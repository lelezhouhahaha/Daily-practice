...
public class LampPlateTestActivity extends BaseActivity implements View.OnClickListener , CheckListAdapter.OnCallBackCheckFunction {
    private LampPlateTestActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_lamp_plate_test;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.LampPlateTestActivity);
        ...
        mDefaultPath = getResources().getString(R.string.lamp_plate_save_log_default_path);
        mFileName = getResources().getString(R.string.lamp_plate_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.lamp_plate_save_log_is_user_custom);
        mCustomPath = getResources().getString(R.string.lamp_plate_save_log_custom_path);
        ...
        List<String> config = Const.getXmlConfig(this,Const.CONFIG_LAMP_PLATE);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1003://test finish
                    ...
                    new LampPlateTestActivity.SaveResult().execute();
                    break;
                case 1004://save log
...
//                    saveLog(false);
    ...
    private boolean isAllSuccess() {
        List<FunctionBean> list = getFatherData(LampPlateTestActivity.super.mName);
...
//        persistResultList = DataUtil.setListOrder(config_list, persistResultList);
    ...
    private void createDialog(){
        String title = getResources().getString(R.string.lamp_plate_result);
