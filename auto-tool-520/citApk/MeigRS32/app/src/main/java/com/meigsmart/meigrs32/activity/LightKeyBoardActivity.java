...
public class LightKeyBoardActivity extends BaseActivity implements View.OnClickListener ,PromptDialog.OnPromptDialogCallBack{
    private LightKeyBoardActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.LightKeyBoardActivity);
