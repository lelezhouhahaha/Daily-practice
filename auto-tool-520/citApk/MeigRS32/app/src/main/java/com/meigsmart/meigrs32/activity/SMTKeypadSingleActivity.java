...
public class SMTKeypadSingleActivity extends BaseActivity implements View.OnClickListener , CheckListAdapter.OnCallBackCheckFunction {
    private SMTKeypadSingleActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.SMTKeypadSingleActivity);

        mDefaultPath = getResources().getString(R.string.SMT_Keypad_single_save_log_default_path);
        mFileName = getResources().getString(R.string.SMT_Keypad_single_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.SMT_Keypad_single_save_log_is_user_custom);
        mCustomPath = getResources().getString(R.string.power_board_single_save_log_custom_path);
        ...
        String Name = getStringFromName(mContext, "SMTKeypadActivity");
        ...
        List<String> config = Const.getXmlConfig(this, Const.CONFIG_SMT_KEYPAD_SINGLE);
