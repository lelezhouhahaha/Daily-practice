...
public class CalibrationActivity extends BaseActivity implements View.OnClickListener , CheckListAdapter.OnCallBackCheckFunction {
    private CalibrationActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.calibration_list_item;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.function_calibration);

        mDefaultPath = getResources().getString(R.string.calibration_save_log_default_path);
        mFileName = getResources().getString(R.string.calibration_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.calibration_save_log_is_user_custom);
        mCustomPath = getResources().getString(R.string.calibration_save_log_custom_path);
        ...
        List<String> config = Const.getXmlConfig(this,Const.CONFIG_CALIBRATION);
    ...
    public void onItemClick(int position) {
        ...
        }else LogUtil.d(this.getLocalClassName() + " CalibrationActivity click too fast.");
    }
