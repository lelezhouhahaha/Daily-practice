...
public class RJ11ATestActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{
    private RJ11ATestActivity mContext;
    @BindView(R.id.title)
    ...
    public  final String TAG_RJ11A_PATH_NODE = "common_cit_rj11a_node";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.RJ11ATestActivity);
        ...
        String path = DataUtil.initConfig(Const.CIT_COMMON_CONFIG_PATH, TAG_RJ11A_PATH_NODE);
