...
public class Camera2Proxy {
    ...
    public void openCamera(int width, int height) {
        ...
        Log.d(TAG,"camera_id_length:"+camera_id[camera_id.length-1]);
        if((camera_id[camera_id.length-1].equals("5"))) {
            ...
            Toast toast = Toast.makeText(mActivity, R.string.camera_msg_no, Toast.LENGTH_LONG);
    ...
    public void releaseCamera() {
        ...
        if (mBackgroundHandler == null) {
            MyApplication.getInstance().getSingleThreadPool().execute(mReleaseRunnable);
        } else {
            mBackgroundHandler.post(mReleaseRunnable);
        }
    ...
    private void stopBackgroundThread() {
        ...
        try {
            ...
            mBackgroundThread.join(3000);//3 sec timeout
