...
public class SixPinOtgActivity extends BaseActivity implements View.OnClickListener,PromptDialog.OnPromptDialogCallBack{
    private SixPinOtgActivity mContext;
    @BindView(com.meigsmart.meigrs32.R.id.title)
    public TextView mTitle;
    @BindView(com.meigsmart.meigrs32.R.id.back)
    public LinearLayout mBack;
    private String mFatherName = "";
    private SixPinOtgActivity.SixpinUsbDeviceReceiver mReceiver = null;
    ...
    private final String MODE_SPIN = "3";
    ...
    protected int getLayoutId() {
        return com.meigsmart.meigrs32.R.layout.activity_spotg;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(com.meigsmart.meigrs32.R.string.SixPinOtgActivity);

        mDialog.setCallBack(this);
        mFatherName = getIntent().getStringExtra("fatherName");
        super.mName = getIntent().getStringExtra("name");
        addData(mFatherName,super.mName);
		writeToFile(OTG_STATE_PATH,MODE_SPIN);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1001:
                    mReceiver = new SixPinOtgActivity.SixpinUsbDeviceReceiver();
    ...
    class SixpinUsbDeviceReceiver extends BroadcastReceiver {
        @Override
