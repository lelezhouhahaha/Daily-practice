...
public class Rear2CameraAutoActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private Rear2CameraAutoActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        if (mCameraPreview.getCameraInstance() == null) {
            ...
            Toast toast = Toast.makeText(Rear2CameraAutoActivity.this, R.string.camera_msg_no, Toast.LENGTH_LONG);
        ...
        if (v == takepicture) {
            if (mCameraPreview != null && mCameraPreview.isPreviewing) {//hejianfeng modif for zendao12318
                ...
                if (takePhoto) {
                    ...
                    Toast toast = Toast.makeText(Rear2CameraAutoActivity.this, R.string.camera_msg_error, Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }
