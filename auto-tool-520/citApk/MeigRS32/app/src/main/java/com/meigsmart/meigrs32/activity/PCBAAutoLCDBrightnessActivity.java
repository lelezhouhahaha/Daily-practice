...
public class PCBAAutoLCDBrightnessActivity extends BaseActivity implements View.OnClickListener ,
        PromptDialog.OnPromptDialogCallBack,Runnable{
    private PCBAAutoLCDBrightnessActivity mContext;
    @BindView(R.id.title)
    ...
    private final String TAG = PCBAAutoLCDBrightnessActivity.class.getSimpleName();
    ...
    protected void initData() {
        ...
        String mBackLight = getIntent().getStringExtra("backlight");
        LogUtil.d(TAG, "mBackLight 1:" + mBackLight);
        background = Integer.parseInt(mBackLight);

        //background = getIntent().getIntExtra("backlight", 50);
