...
public class RearCameraVisionActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack {
    private RearCameraVisionActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_rear_camera_vision;
    }
    ...
    protected void initData() {
        ...
        if (mCameraPreview.getCameraInstance() == null) {
            ...
            Toast toast = Toast.makeText(RearCameraVisionActivity.this, R.string.camera_msg_no, Toast.LENGTH_LONG);
        ...
        if (v == takepicture) {
            if (mCameraPreview != null && mCameraPreview.isPreviewing) {//hejianfeng modif for zendao12318
                ...
                if (takePhoto) {
                    ...
                    Toast toast = Toast.makeText(RearCameraVisionActivity.this, R.string.camera_msg_error, Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                }
