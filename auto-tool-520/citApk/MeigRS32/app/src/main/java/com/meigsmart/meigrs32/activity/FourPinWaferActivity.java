...
public class FourPinWaferActivity extends BaseActivity implements View.OnClickListener, PromptDialog.OnPromptDialogCallBack{

    private FourPinWaferActivity mContext;
    @BindView(R.id.title)
    ...
    protected int getLayoutId() {
        return R.layout.activity_four_pin_wafer;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.run_in_fourpintest);
    ...
    private void showDialog() {
        AlertDialog.Builder dialog =
                new AlertDialog.Builder(FourPinWaferActivity.this);
