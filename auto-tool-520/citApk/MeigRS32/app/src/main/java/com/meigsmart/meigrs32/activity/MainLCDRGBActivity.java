...
public class MainLCDRGBActivity extends BaseActivity implements View.OnClickListener ,
        PromptDialog.OnPromptDialogCallBack ,Runnable{
    private MainLCDRGBActivity mContext;
    ...
    protected int getLayoutId() {
        return R.layout.activity_main_lcdrgb;
    }
