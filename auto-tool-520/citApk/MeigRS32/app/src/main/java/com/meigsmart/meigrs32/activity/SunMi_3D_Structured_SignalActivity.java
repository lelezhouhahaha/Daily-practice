...
public class SunMi_3D_Structured_SignalActivity extends BaseActivity implements View.OnClickListener, CheckListAdapter.OnCallBackCheckFunction {
    private SunMi_3D_Structured_SignalActivity mContext;
    @BindView(R.id.title)
    ...
    private String TAG = "SunMi_3D_Structured_SignalActivity";
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.sunmi_3d_structured_signal);
        ...
        String Name = getStringFromName(mContext, "SunMi_3D_Structured_SignalActivity");
        if (!TextUtils.isEmpty(Name)) {
            super.mList = getFatherData(Name);
        }

        List<String> config = Const.getXmlConfig(this, Const.CONFIG_SUNMI_3D_STRUCTURED_SIGNAL);
