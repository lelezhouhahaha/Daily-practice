...
public class SixPinUartActivity extends BaseActivity implements View.OnClickListener,PromptDialog.OnPromptDialogCallBack{
    private SixPinUartActivity mContext;
    ...
    private String NPUART_PATH = "/dev/ttyMSM3";
    private Thread mThread;
    private Runnable mRunnable;

    @Override
    protected int getLayoutId() {
        return com.meigsmart.meigrs32.R.layout.activity_spuart;
    }
    ...
    protected void initData() {
        ...
        mTitle.setText(com.meigsmart.meigrs32.R.string.SixPinUartActivity);
        ...
        mRunnable = new Runnable() {
            @Override
            public void run() {
                mSerialPort.uhf_test(NPUART_PATH,baud, "ufh test");
