...
public class PowerBoardSingleActivity extends BaseActivity implements View.OnClickListener , CheckListAdapter.OnCallBackCheckFunction {
    private PowerBoardSingleActivity mContext;
    @BindView(R.id.title)
    ...
    protected void initData() {
        ...
        mTitle.setText(R.string.PowerBoardSingleActivity);

        mDefaultPath = getResources().getString(R.string.power_board_single_save_log_default_path);
        mFileName = getResources().getString(R.string.power_board_single_save_log_file_name);
        isCustomPath = getResources().getBoolean(R.bool.power_board_single_save_log_is_user_custom);
        ...
        String Name = getStringFromName(mContext, "PowerBoardActivity");
