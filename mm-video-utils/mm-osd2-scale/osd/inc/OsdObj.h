...
private:
	...
	uint_32 osd_res_x;
	uint_32 osd_res_y;
	uint_32 osd_480p_res_x;
	uint_32 osd_480p_res_y;
	uint_32 osd_id;
	string osd_name;
	string osd_content;
	bool osd_hide;
...
public:
	...
	void get480pOsdRes(uint_32 *x_480p, uint_32 *y_480p);
	void set480pOsdRes(uint_32 x_480p, uint_32 y_480p);

	uint_32 getOsdFontSize();
	void setOsdFontSize(int new_font_size);
	...
	char *getOsd480pYuvBufP();
	void setOsd480pYuvBufP(char *p480YuvBuf);
