...
#define FONT_LIB "/system/etc/camera/simblack.ttf"
...
int SDL_TTF_Render(TTF_Font * font, char *str, char *name, int *x_res, int *y_res)
{
    ...
    SDL_Color forecol = { 0xc6, 0xc6, 0xc6, 0xc6 };
...
void SDL_TTF_Deinit(TTF_Font *font,TTF_Font *font_480)
{
	TTF_CloseFont(font);
	TTF_CloseFont(font_480);
	TTF_Quit();
}
