...
void OsdObj::setOsdFontSize(int new_font_size){
	osd_font_size = new_font_size;
}
...
char* OsdObj::getOsd480pYuvBufP(){
	return osd_480p_yuv_buf;
}

void OsdObj::setOsd480pYuvBufP(char *p480YuvBuf){
	osd_480p_yuv_buf = p480YuvBuf;
}
...
void OsdObj::get480pOsdRes(uint_32 *x_480p, uint_32 *y_480p){
	*x_480p = osd_480p_res_x;
	*y_480p = osd_480p_res_y;
}

void OsdObj::set480pOsdRes(uint_32  x_480p, uint_32  y_480p){
	osd_480p_res_x = x_480p;
	osd_480p_res_y = y_480p;
}
